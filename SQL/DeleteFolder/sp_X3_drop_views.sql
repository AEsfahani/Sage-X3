...
declare MonCurseur INSENSITIVE CURSOR
	for 
 	   select name from sysobjects where type = 'V' and name like '%' and schema_name(uid) = @table_owner and db_name () = @database_name
open MonCurseur
